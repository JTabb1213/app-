#!/usr/bin/env python3
"""
Jupiter / Solana WebSocket smoke test.

Connects to the Solana mainnet websocket node and subscribes to slot updates.
This verifies that the Solana-based DEX path can receive live data.
"""
...
async def main() -> None:
    print("=" * 72)
    print("  Jupiter / Solana WebSocket Test")
    print("=" * 72)
    print(f"  URL: {WS_URL}")
