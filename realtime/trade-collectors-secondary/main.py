#!/usr/bin/env python3
"""
Trade Collectors-Secondary Service
=====================================

Connects to OKX, Gate.io, MEXC, and Pionex TRADE websocket feeds
and pushes raw trade executions to the Redis Stream for volume aggregation.

Usage:
    cd realtime/trade-collectors-secondary
    python main.py
"""
...
from exchanges.okx_trades import OkxTradeConnector
from exchanges.gateio_trades import GateioTradeConnector
from exchanges.mexc_trades import MexcTradeConnector
from exchanges.pionex_trades import PionexTradeConnector
from exchanges.bybit_trades import BybitTradeConnector
...
logger = logging.getLogger("trade-collectors-secondary")
...
async def _health_handler(request):
    info = {
        "status": "healthy",
        "service": "trade-collectors-secondary",
        "exchanges": ["okx", "gateio", "bybit", "pionex"],
...
async def main():
    ...
    logger.info("=" * 60)
    logger.info("  Trade Collectors-Secondary (OKX, Gate.io, Bybit, Pionex)")
    logger.info("=" * 60)
    ...
    _connectors = [okx, gateio, bybit, pionex]
